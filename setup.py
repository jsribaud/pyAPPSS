...
#
setup_keywords['version'] = '0.1.0b22' #get_version(setup_keywords['name'])
#
...
setup_keywords['scripts'] = ['pyappss/scripts/agc_plot.py',
                             'pyappss/scripts/reduce.py',
                             'pyappss/scripts/tmp.py',
                             'pyappss/analysis/baseline.py',
                             'pyappss/analysis/FunctionOrders.py',
                             'pyappss/analysis/measure.py',
                             'pyappss/analysis/multigauss.py',
                             'pyappss/analysis/smooth.py',
                             'pyappss/file_conversion/convert.py']
...
data_generator = os.walk('pyappss/data')
